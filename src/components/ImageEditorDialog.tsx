...
export function ImageEditorDialog({ isOpen, onClose, image }: ImageEditorDialogProps) {
  ...
  const [originalDimensions, setOriginalDimensions] = useState({ width: 512, height: 512 });
  const [targetDimensions, setTargetDimensions] = useState({ width: 512, height: 512 });
        ...
        <div className="flex h-full">
          ...
          <div className="flex-1 relative flex items-center justify-center bg-slate-100 p-8">
            ...
            <div className="relative">
              ...
              <div 
                className="absolute inset-0 -m-16 opacity-50"
                style={{
              ...
              <img 
                src={image.src} 
                alt={image.alt} 
                className="relative z-10 max-w-[400px] max-h-[400px] object-contain"
                style={{
